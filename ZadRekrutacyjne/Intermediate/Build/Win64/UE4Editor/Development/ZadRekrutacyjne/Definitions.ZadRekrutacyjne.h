...
#define UE_PROJECT_NAME ZadRekrutacyjne
#define UE_TARGET_NAME ZadRekrutacyjneEditor
#define UE_MODULE_NAME "ZadRekrutacyjne"
...
#define ZADREKRUTACYJNE_API DLLEXPORT
